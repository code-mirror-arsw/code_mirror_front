  ...
  const handleApply = async () => {
    ...
    try {
      const res = await fetch(
        `https://apigateway-b8exa0bnakh6bvhx.canadacentral-01.azurewebsites.net/services/be/offer-service/offers/${offerId}/participants?intervieweeId=${intervieweeId}`,
        {
          method: "POST",
          headers: {
